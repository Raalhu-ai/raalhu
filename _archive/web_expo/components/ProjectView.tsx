						...
						<div className="flex-1 min-w-0 flex flex-col gap-5">
							...
							<div className="flex items-start gap-3 py-4">
								...
								<div className="relative">
									...
									{showMenu && (
										<div className="absolute start-0 top-full mt-1 w-40 bg-card border border-border rounded-lg shadow-lg z-50 py-1">
											<button
												onClick={startRename}
												className="thaana flex items-center gap-2 w-full px-3 py-2 text-xs hover:bg-accent transition-colors text-right"
											>
												<PenLine size={12} className="inline" /> ނަން ބަދަލުކުރޭ
											</button>
